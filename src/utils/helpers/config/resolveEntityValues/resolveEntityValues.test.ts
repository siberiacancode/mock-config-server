...
describe('resolveEntityValues', () => {
  test('Should throw error if provided wrong checkMode', () => {
    expect(() => resolveEntityValues('wrongCheckMode' as CheckMode, '123', '123'))
      .toThrow(new Error('Wrong checkMode'));
  });
  ...
  describe('"equals" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('equals', [11, 12, '12'], '12')).toBe(true);
        expect(resolveEntityValues('equals', [11, 13, '13'], '12')).toBe(false);
      })
    })
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be full equal with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('equals', ['true', '2', 'string'], [true, 2, 'string'])).toBe(true);
        expect(
          resolveEntityValues('equals',
    ...
    describe('actual: array, descriptor: object', () => {
      test('Should compare every actual array element with object descriptor value by "OR" logic', () => {
        ...
        expect(resolveEntityValues('equals', [{ key: 'value' }, { key: 'value2' }], { key: 'value' })).toBe(true);
      })
    })
    ...
    describe('actual: object, descriptor: array', () => {
      test('Should compare actual object value with every descriptor object value by "OR" logic', () => {
        ...
        expect(
          resolveEntityValues('equals',
            { user: { phone: '79091230102' } },
            [{ user: { phone: '7' } }, { user: { phone: '8' } }]
          )
        ).toBe(false);
        expect(
          resolveEntityValues('equals',
            { user: { phone: '99091230102' } },
            [{ user: { phone: '99091230102' } }, { user: { phone: '89091230102' } }]
          )
        ).toBe(true);
      })
    })
    describe('actual: object, descriptor: object', () => {
      test('Plain objects should compare by "actualValue includes descriptorValue" with nested objects', () => {
        expect(
          resolveEntityValues('equals',
            { key1: 'value1', key2: 'value2', key3: 'value3' },
            { key1: 'value1', key2: 'value2' }
  ...
  describe('"notEquals" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('notEquals', [11, 12, '12'], '12')).toBe(false);
        expect(resolveEntityValues('notEquals', [11, 13, '13'], '12')).toBe(true);
      })
    })
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be full equal with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('notEquals', ['true', '2', 'string'], [true, 2, 'string'])).toBe(false);
        expect(
          resolveEntityValues('notEquals',
            [{ key1: 'value1', key2: '111' }],
            [{ key2: 111, key1: 'value1' }]
          )
        ).toBe(false);
  ...
  describe('"includes" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('includes', [113, 1222, '312'], '12')).toBe(true);
    ...
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be fully checked for "includes" with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('includes', ['truee', '32', '53string'], [true, 2, 'string'])).toBe(true);
        expect(
          resolveEntityValues('includes',
    ...
    describe('actual: array, descriptor: object', () => {
      test('Should compare every actual array element with object descriptor value by "OR" logic', () => {
        ...
        expect(resolveEntityValues('includes', [{ key: 'value33' }], { key: 'value' })).toBe(true);
      })
    })
  ...
  describe('"notIncludes" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('notIncludes', [113, 1222, '312'], '12')).toBe(false);
    ...
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be fully checked for "notIncludes" with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('notIncludes', ['truee', '32', '53string'], [true, 2, 'string'])).toBe(false);
        expect(
          resolveEntityValues('notIncludes',
            [{ key1: 'value122', key2: '31113' }],
            [{ key2: 111, key1: 'value1' }]
          )
        ).toBe(false);
    ...
    describe('actual: array, descriptor: object', () => {
      test('Should compare every actual array element with object descriptor value by "OR" logic', () => {
        ...
        expect(resolveEntityValues('notIncludes', [{ key: 'value33' }], { key: 'value' })).toBe(false);
      })
    })
    ...
    describe('actual: object, descriptor: array', () => {
      test('Should compare actual object value with every descriptor object value by "OR" logic', () => {
        expect(resolveEntityValues('notIncludes', { key: 'value' }, [])).toBe(true);
        expect(resolveEntityValues('notIncludes', { key: 'value' }, [true, 2, 'string'])).toBe(true);
        expect(resolveEntityValues('notIncludes', { key: '1value2' }, [{ key: 'value' }])).toBe(false);
        expect(
          resolveEntityValues('notIncludes',
            { user: { phone: '99091230102' } },
            [{ user: { phone: '7' } }, { user: { phone: '8' } }]
  ...
  describe('"startsWith" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('startsWith', [113, 1222, '312'], '12')).toBe(true);
    ...
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be fully checked for "startsWith" with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('startsWith', ['truee', '23', 'string12'], [true, 2, 'string'])).toBe(true);
        expect(
          resolveEntityValues('startsWith',
    ...
    describe('actual: array, descriptor: object', () => {
      test('Should compare every actual array element with object descriptor value by "OR" logic', () => {
        ...
        expect(resolveEntityValues('startsWith', [{ key: 'value33' }], { key: 'value' })).toBe(true);
      })
    })
    ...
    describe('actual: object, descriptor: array', () => {
      test('Should compare actual object value with every descriptor object value by "OR" logic', () => {
        expect(resolveEntityValues('startsWith', { key: 'value' }, [])).toBe(false);
        expect(resolveEntityValues('startsWith', { key: 'value' }, [true, 2, 'string'])).toBe(false);
        expect(resolveEntityValues('startsWith', { key: 'value12' }, [{ key: 'value' }])).toBe(true);
        expect(
          resolveEntityValues('startsWith',
            { user: { phone: '99091230102' } },
            [{ user: { phone: '7' } }, { user: { phone: '8' } }]
  ...
  describe('"notStartsWith" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('notStartsWith', [113, 1222, '312'], '12')).toBe(false);
    ...
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be fully checked for "notStartsWith" with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('notStartsWith', ['truee', '23', 'string12'], [true, 2, 'string'])).toBe(false);
        expect(
          resolveEntityValues('notStartsWith',
            [{ key1: 'value122', key2: '1113' }],
            [{ key2: 111, key1: 'value1' }]
          )
        ).toBe(false);
    ...
    describe('actual: array, descriptor: object', () => {
      test('Should compare every actual array element with object descriptor value by "OR" logic', () => {
        ...
        expect(resolveEntityValues('notStartsWith', [true, 2, 'value'], { key: 'value' })).toBe(true);
        expect(resolveEntityValues('notStartsWith', [{ key: 'value33' }], { key: 'value' })).toBe(false);
      })
    })
    ...
    describe('actual: object, descriptor: array', () => {
      test('Should compare actual object value with every descriptor object value by "OR" logic', () => {
        expect(resolveEntityValues('notStartsWith', { key: 'value' }, [])).toBe(true);
        expect(resolveEntityValues('notStartsWith', { key: 'value' }, [true, 2, 'string'])).toBe(true);
        expect(resolveEntityValues('notStartsWith', { key: 'value12' }, [{ key: 'value' }])).toBe(false);
        expect(
          resolveEntityValues('notStartsWith',
            { user: { phone: '99091230102' } },
            [{ user: { phone: '7' } }, { user: { phone: '8' } }]
  ...
  describe('"endsWith" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('endsWith', [113, 1222, '312'], '12')).toBe(true);
    ...
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be fully checked for "endsWith" with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('endsWith', ['1true', '32', '12string'], [true, 2, 'string'])).toBe(true);
        expect(
          resolveEntityValues('endsWith',
    ...
    describe('actual: array, descriptor: object', () => {
      test('Should compare every actual array element with object descriptor value by "OR" logic', () => {
        ...
        expect(resolveEntityValues('endsWith', [{ key: '33value' }], { key: 'value' })).toBe(true);
      })
    })
  ...
  describe('"notEndsWith" checkMode', () => {
    ...
    describe('actual: array, descriptor: primitive', () => {
      test('Should compare every actual array element with primitive descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('notEndsWith', [113, 1222, '312'], '12')).toBe(false);
    ...
    describe('actual: array, descriptor: array', () => {
      test('Arrays should be fully checked for "notEndsWith" with nested objects (independent of primitive values types)', () => {
        expect(resolveEntityValues('notEndsWith', ['1true', '32', '12string'], [true, 2, 'string'])).toBe(false);
        expect(
          resolveEntityValues('notEndsWith',
            [{ key1: '22value1', key2: '3111' }],
            [{ key2: 111, key1: 'value1' }]
          )
        ).toBe(false);
    ...
    describe('actual: array, descriptor: object', () => {
      test('Should compare every actual array element with object descriptor value by "OR" logic', () => {
        ...
        expect(resolveEntityValues('notEndsWith', [{ key: '33value' }], { key: 'value' })).toBe(false);
      })
    })
    ...
    describe('actual: object, descriptor: array', () => {
      test('Should compare actual object value with every descriptor object value by "OR" logic', () => {
        expect(resolveEntityValues('notEndsWith', { key: 'value' }, [])).toBe(true);
        expect(resolveEntityValues('notEndsWith', { key: 'value' }, [true, 2, 'string'])).toBe(true);
        expect(resolveEntityValues('notEndsWith', { key: '12value' }, [{ key: 'value' }])).toBe(false);
        expect(
          resolveEntityValues('notEndsWith',
            { user: { phone: '99091230102' } },
            [{ user: { phone: '0' } }, { user: { phone: '1' } }]
  ...
  describe('"regExp" checkMode', () => {
    ...
    describe('actual: array, descriptor: regExp', () => {
      test('Should compare every actual array element with regExp descriptor value by "OR" logic', () => {
        expect(resolveEntityValues('regExp', [{ key: 'value' }, 11, 12, '12'], /^12$/)).toBe(true);
    ...
    describe('actual: array, descriptor: regExpArray', () => {
      test('Arrays should be fully compared by corresponding regExp (independent of primitive values types)', () => {
        expect(resolveEntityValues('regExp', [true, 2, 'string', { key: 'value' }], [/^true$/, /^2$/, /^string$/, /\[object Object]/])).toBe(true);
        expect(resolveEntityValues('regExp', [true, 3, 'string'], [/^true$/, /^2$/, /^string$/])).toBe(false);
      });
    })

    describe('actual: object, descriptor: regExp', () => {
      test('Any object should be cast to string before regExp test', () => {
        expect(resolveEntityValues('regExp', {}, /^12$/)).toBe(false);
        expect(resolveEntityValues('regExp', { key: 'value' }, /^value$/)).toBe(false);
        expect(resolveEntityValues('regExp', { key: 'value' }, /\[object Object]/)).toBe(true);
      });
    })
    describe('actual: object, descriptor: array', () => {
      test('Any object should not be satisfied to regExp', () => {
        expect(
          resolveEntityValues('regExp',
            { key1: 'value1', key2: '111' },
            [/^\d\d\d$/, /^value\d$/]
          )
        ).toBe(false);
  ...
  describe('"function" checkMode', () => {
        ...
        expect(resolveEntityValues(
          ...
          (actualValue: string, checkFunction: CheckFunction) =>
            checkFunction(
              ...
              actualValue,
              () =>
                actualValue === 'string2'))).toBe(true);
      })
      test('All primitive values should be count as first argument in descriptor function', () => {
        expect(resolveEntityValues('function', '12', (actualValue: string) => actualValue === '12')).toBe(true);
        expect(resolveEntityValues('function', true, (actualValue: string) => actualValue)).toBe(true);
        expect(resolveEntityValues('function', null, (actualValue: string) => !actualValue)).toBe(true);
    ...
    describe('actual: array, descriptor: function', () => {
      test('Any array should be count as first argument in descriptor function', () => {
        expect(resolveEntityValues('function', ['true', '2'], ([first, second]: string[]) => first === 'true' && second === '2')).toBe(true);
        expect(
          resolveEntityValues('function',
            [{ key1: 'value1' }, { key2: '111' }],
            (actualValue: Record<string, string>[]) => actualValue[0].key1 === 'value1' && actualValue[1].key2 === '111'
          )
        ).toBe(true);
      })
    })
    ...
    describe('actual: object, descriptor: function', () => {
      test('Any object should be count as first argument in descriptor function', () => {
        expect(resolveEntityValues('function',
          { key1: 'value1', key2: 'value2' },
          (actualValue: Record<string, string>) => actualValue.key1 === 'value1' && actualValue.key2 === 'value2'
        )
      ).toBe(true);
      });
    })
